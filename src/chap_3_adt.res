...
let _ =bookFormatToString(Audible) // "Audible"
...
let _ = isElectronic(Audible) // true
...
`<div>
    ...
    <p>${Belt.Int.toString(book.availableInStock)} new ${bookFormatToString(book.format)} available in stock</p>
</div>`
}
/*
